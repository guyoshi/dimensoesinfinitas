(() => {
  ...
  for(const item of fauna){if(item[0]==='Raukhar'){item[0]='Rhaukar';item[3]='Citado no Livro I apenas como “a Fera” ou pela descrição dos olhos amarelos. É a mesma criatura conhecida posteriormente como Rhaukar.';}}
  D.canonicalAudit=D.canonicalAudit||{};
  D.canonicalAudit.stage=3;
  D.canonicalAudit.aliases={...(D.canonicalAudit.aliases||{}),Rhaukar:['Raukhar','a Fera','Fera de olhos amarelos']};
})();
