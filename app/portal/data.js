window.PORTAL_DATA = {
  "sagas": [
    {
      ...
      "name": "Ciclo de Jesed",
      "status": "active",
      "theme": "Mapa de explorador",
      "symbol": "compass",
      "tagline": "Tudo nasce, cresce e morre. Para depois recomeçar."
    },
    {
      "id": "diario-sobrenatural",
      "name": "Diário Sobrenatural",
      "status": "locked",
      "theme": "Diário oculto",
      "symbol": "journal"
    },
    {
      "id": "cronicas-de-belfex",
      "name": "Crônicas de Belfex",
      "status": "locked",
      "theme": "Crônica dimensional",
      "symbol": "crown"
    },
    {
      "id": "spacetheft",
    ...
    {
      "id": "viajantes-dimensionais",
      "name": "Viajantes Dimensionais",
      "status": "locked",
      "theme": "Portais e fracturas",
      "symbol": "portal"
    },
    {
      "id": "misterio-oculto",
      "name": "Mistério Oculto",
      "status": "locked",
      "theme": "Arquivo de investigação",
      "symbol": "eye"
    },
    {
      "id": "a-uniao",
  ...
  "books": [
    ...
    {
      "id": "guerras-de-sangue",
      "order": 2,
      "name": "Guerras de Sangue",
      "status": "active",
      "icon": "crossed-swords",
    ...
    {
      "id": "coracao-de-poeira",
      "order": 5,
      "name": "Coração de Poeira",
      "status": "locked",
      "icon": "hourglass",
