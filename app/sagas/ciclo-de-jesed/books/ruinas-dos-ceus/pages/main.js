...
function inicio(){
  ...
  return `<section class="hero-map-card home-guide-hero">
    <img src="assets/maps/ruinas-dos-ceus/mapa-combinado.webp" alt="Mapa de Etérea e da Superfície">
  ...
  <section class="section home-map-overview"><div class="section-heading home-section-heading"><div><p class="eyebrow">Dois períodos cartográficos</p><h2>Etérea e A Superfície</h2><p>O mapa muda com a Queda: primeiro a civilização suspensa; depois a floresta desconhecida.</p></div><button class="secondary-button home-light-button" data-go="mapa">Abrir mapas interativos</button></div><div class="home-map-preview-grid"><button class="home-map-preview" data-map-open="eterea"><img src="assets/maps/ruinas-dos-ceus/Mapa de Etérea.webp" alt="Mapa de Etérea"><span><small>Capítulos 1 a 9</small><strong>Etérea</strong><em>Civilização suspensa · vento e leveza</em></span></button><button class="home-map-preview" data-map-open="superficie"><img src="assets/maps/ruinas-dos-ceus/Mapa de Nadírion (Floresta de Mirval).webp" alt="Mapa da Superfície"><span><small>Capítulos 10 a 24</small><strong>A Superfície</strong><em>Sobrevivência · terra, peso e fome</em></span></button></div></section>
