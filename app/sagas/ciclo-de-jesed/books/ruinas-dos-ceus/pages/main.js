...
function inicio(){
  ...
  return `<section class="hero-map-card home-guide-hero">
    <img src="assets/books/ciclo-de-jesed/ruinas-dos-ceus/maps/map-combined.webp" alt="Mapa de Etérea e da Superfície">
